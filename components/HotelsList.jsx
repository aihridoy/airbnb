                            ...
                            {currentHotels.map((hotel) => {
                                ...
                                return (
                                    <tr key={hotel._id} className="border-t hover:bg-gray-50">
                                        ...
                                        <td className="p-4 font-semibold text-zinc-800">{hotel.title}</td>
                                        <td className="p-4 text-zinc-600">{hotel.location}</td>
                                        <td className="p-4 text-zinc-600">{hotel.bedroomCapacity} Rooms</td>
                                        <td className="p-4 text-rose-600 font-semibold">${hotel.rent}</td>
                                        <td className="p-4">
